...
public:
    //! Gets info about the specified filename and specified backend.
    static MediaData getInfo( BackendFactory::BackendType backend_type, QString filename );

    //! Gets info about the specified filename. The mplayer executable will be
    // obtained from the global preferences.
    static MediaData getInfo( const QString &filename );
