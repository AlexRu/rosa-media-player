...
void Screen::paintEvent( QPaintEvent * e )
{
    ...
    painter.fillRect( e->rect(), background_color );
}
...
void Screen::playingStopped()
{
    ...
    //Fix bug: if cursor was hide, when stop occurs, it not shown after move.
    setAutoHideCursor(false);
    setCursor(QCursor(Qt::ArrowCursor));
#endif
}
...
//    ColorUtils::setBackgroundColor( this, QColor(0,0,0) );
    ...
    QVBoxLayout * mplayerlayerLayout = new QVBoxLayout( this );
...
#ifndef MINILIB
    logo->setPixmap( Images::pixmap("background") );
#endif
}
...
void MplayerWindow::updateBackgroundColor( bool b )
{
    QColor color = b ? QColor( 51, 51, 51 ) : QColor( 0, 0, 0 );
    setBackgroundColor( color );
    mplayerlayer->setBackgroundColor(color);
    ColorUtils::setBackgroundColor( logo, color );
    ColorUtils::setBackgroundColor( this, color );
    ColorUtils::setBackgroundColor( mplayerlayer, color );
